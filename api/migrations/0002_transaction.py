# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-13 04:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True, verbose_name='Transaction unique identifier')),
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='CLP', max_digits=10, verbose_name='Money to exchange')),
                ('status', models.CharField(choices=[('WAIT', 'WAIT'), ('EXEC', 'EXEC'), ('ERR', 'ERR')], default='WAIT', max_length=4, verbose_name='Current transaction status code.')),
                ('status_description', models.TextField(blank=True, null=True, verbose_name='Description related to the status.')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('app', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.ApplicationToken')),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipient', to='api.KreditCard')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sender', to='api.KreditCard')),
            ],
        ),
    ]
